...
#define QEI_R_B_Pin GPIO_PIN_4
#define QEI_R_B_GPIO_Port GPIOA
#define QEI_R_B_EXTI_IRQn EXTI4_IRQn
...
#define QEI_L_A_EXTI_IRQn EXTI9_5_IRQn
#define QEI_L_B_Pin GPIO_PIN_9
