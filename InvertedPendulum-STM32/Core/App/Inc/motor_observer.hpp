...
public:
    ...
    float estimateCurrent(float voltage_command, float motor_speed, float measured_current);
    float getCorrectedCurrent(float measured_current, float voltage_command, float motor_speed);
