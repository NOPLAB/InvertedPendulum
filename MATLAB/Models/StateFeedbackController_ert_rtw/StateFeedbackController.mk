###########################################################################
## Makefile generated for component 'StateFeedbackController'. 
## 
## Makefile     : StateFeedbackController.mk
## Generated on : Sat Jun 14 09:38:45 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/StateFeedbackController.out
...
PRODUCT_NAME              = StateFeedbackController
MAKEFILE                  = StateFeedbackController.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2024b
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2024b/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/nopla/dev/InvertedPendulum/MATLAB/Models
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/StateFeedbackController.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/StateFeedbackController_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=StateFeedbackController -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/StateFeedbackController_ert_rtw/StateFeedbackController.c
...
OBJS = StateFeedbackController.obj
...
%.obj : $(START_DIR)/StateFeedbackController_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/StateFeedbackController_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/StateFeedbackController_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/StateFeedbackController_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
StateFeedbackController.obj : $(START_DIR)/StateFeedbackController_ert_rtw/StateFeedbackController.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
