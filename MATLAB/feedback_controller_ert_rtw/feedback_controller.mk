###########################################################################
## Makefile generated for component 'feedback_controller'. 
## 
## Makefile     : feedback_controller.mk
## Generated on : Sun Jul 06 09:38:27 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\feedback_controller.exe
...
COMPILER_COMMAND_FILE     = feedback_controller_comp.rsp
CMD_FILE                  = feedback_controller.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\feedback_controller.exe
...
DEFINES_STANDARD = -DMODEL=feedback_controller -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)\feedback_controller_ert_rtw\feedback_controller.cpp

MAIN_SRC = $(START_DIR)\feedback_controller_ert_rtw\ert_main.cpp
...
{$(START_DIR)\feedback_controller_ert_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\feedback_controller_ert_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\feedback_controller_ert_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\feedback_controller_ert_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
ert_main.obj : "$(START_DIR)\feedback_controller_ert_rtw\ert_main.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\feedback_controller_ert_rtw\ert_main.cpp"


feedback_controller.obj : "$(START_DIR)\feedback_controller_ert_rtw\feedback_controller.cpp"
	$(CPP) $(CPPFLAGS) -Fo"$@" "$(START_DIR)\feedback_controller_ert_rtw\feedback_controller.cpp"
