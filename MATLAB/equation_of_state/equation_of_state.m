...
nonlinear_A = jacobian(f_nonlinear, state_vars);
nonlinear_B = jacobian(f_nonlinear, input_var);

matlabFunction(nonlinear_A, nonlinear_B, 'File','equation_of_state/nonlinear_A_B_matrix', 'Vars', {state_vars, input_var, params});
