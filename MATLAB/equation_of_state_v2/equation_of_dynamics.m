...
% 非線形動力学関数
matlabFunction(f_nonlinear, 'File', 'equation_of_state/functions/nonlinear_dynamics', ...
    'Vars', {state_vars, input_var, params}, ...
    'Outputs', {'dXdt'});

% 線形化行列関数
matlabFunction(A_linear, B_linear, 'File', 'equation_of_state/functions//linearized_matrices', ...
    'Vars', {params}, ...
    'Outputs', {'A', 'B'});

% 慣性行列と右辺ベクトル（運動方程式用）
matlabFunction(M_matrix, rhs, 'File', 'equation_of_state/functions/equations_of_motion', ...
